...
(function () {
  const PRODUCTS = [
    ...
    {
      id: 'zl', code: 'ZL', nameZh: '黃豆油', name: 'Soybean Oil',
      cur: 'US$', mult: 600, unitLabel: '×US$600/¢ · 60,000 lb',
      strikeStep: 1, pxDecimals: 3,
      model: 'b76', r: 4.0, skew: 'call',
      defaultSpot: 69, defaultIv: 26,
      spotMin: 45, spotMax: 95, spotStep: 0.01,
      ivMin: 10, ivMax: 70,
      settleNote: '13:20 CT',
      ivBase: { std: 26 },
      fees: { perSide: 2.5, taxRate: 0 },
      live: 'ib', livePositions: true,
      ib: { symbol: 'ZL', exchange: 'CBOT', tradingClass: 'OZL' },
      mockExpiries: [
        { id: 'm1', label: 'OCT', dte: 11, type: 'std', date: '9/25'  },
        { id: 'm2', label: 'NOV', dte: 39, type: 'std', date: '10/23' },
        { id: 'm3', label: 'DEC', dte: 67, type: 'std', date: '11/20' },
    ...
    },
    {
      ...
      strikeStep: 1,
      model: 'b76', r: 4.0, skew: 'call',
      defaultSpot: 102.70, defaultIv: 33,
      spotMin: 55, spotMax: 140, spotStep: 0.05,
      ivMin: 15, ivMax: 80,
      settleNote: '14:30 CT',
      ivBase: { std: 33 },
      fees: { perSide: 2.5, taxRate: 0 },
