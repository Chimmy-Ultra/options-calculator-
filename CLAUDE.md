...
- **ZM / ZL / LE / HE** 黃豆粉 / 黃豆油 / 活牛 / 瘦肉豬 — the 農副產品 set (Black-76, US$): ZM US$/short ton ×100, ZL ¢/lb ×US$600, LE and HE ¢/lb ×US$400. Multipliers are read from IB's own option descriptions in the capture (`sampleDescription`) — check them there before changing `products.js`.
